...
abstract contract BaseKeyStoreAdapter is IKeyStore {
    ...
    function _insertLeaf(bytes32 slot, bytes32 key) internal {
        _keyGuard(key);
        keyStoreStorage().insertLeaf(slot, key);
    }
