 ...
 */
interface IKeyStoreMerkleProof {
    /**
 ...
 */
abstract contract BaseMerkleTree is IKeyStoreMerkleProof {
    ...
    function _insertLeaf(bytes32 slot, bytes32 signingKeyHash) internal {
        ...
        bytes32 node = keccak256(abi.encodePacked(slot, signingKeyHash, block.number));
